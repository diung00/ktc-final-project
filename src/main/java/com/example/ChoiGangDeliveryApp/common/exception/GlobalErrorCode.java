...
public enum GlobalErrorCode {
    ...
    EMAIL_NOT_VERIFIED(HttpStatus.CONFLICT, "1017", "이메일이 확인되지 않았습니다."),
    INVALID_ROLE_FOR_REQUEST(HttpStatus.CONFLICT, "1018", "일반 사용자만 역할을 전환할 수 있습니다."),
    DUPLICATE_DRIVER_REQUEST(HttpStatus.CONFLICT, "1019", "사용자가 이미 드라이브 역할을 전달하도록 요청했습니다."),
    // email errors
